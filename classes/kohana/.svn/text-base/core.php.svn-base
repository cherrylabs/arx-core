...
class kohana_core
{
     ...
     */
    public static $magiKohana_quotes = FALSE;
     ...
     *
     * - Disables register_globals and magiKohana_quotes_gpc
    ...
    public static function init(array $settings = NULL)
    {
        ...
        Kohana::$magiKohana_quotes = (bool) get_magiKohana_quotes_gpc();
    ...
    public static function sanitize($value)
    {
        if (is_array($value) OR is_object($value)) {
            ...
            if (Kohana::$magiKohana_quotes === TRUE) {
