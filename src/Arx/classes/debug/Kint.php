 ...
 */
if(!defined('KINT_DIR')) define('KINT_DIR', dirname( __FILE__ ) . '/' );
require_once KINT_DIR . 'config.default.php';
require_once __DIR__ . '/parsers/parser.class.php';
require_once __DIR__.'/decorators/rich.php';
...
class Kint
{
	...
	protected static $_statements = array( 'include', 'include_once', 'require_once', 'require_once_once' );
	...
	/**
	 * removes comments and zaps whitespace & <?php namespace Arx\classes\debug;tags from php code, makes for easier further parsing
	 *
	 * @param string $source
	 *
	 * @return string
